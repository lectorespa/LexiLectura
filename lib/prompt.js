...
PASO PREVIO OBLIGATORIO: DETECCIÓN Y TRADUCCIÓN DE IDIOMA
Antes de generar el análisis filológico y el objeto JSON:
1. Analiza el idioma del texto de entrada.
2. SI EL TEXTO NO ESTÁ EN ESPAÑOL (ej. inglés, francés, italiano, latín, etc.):
   - TRADÚCELO COMPLETAMENTE AL ESPAÑOL con máxima calidad literaria.
   - El texto que debes incluir en el campo "stanzas" DEBE SER LA TRADUCCIÓN AL ESPAÑOL.
   - Todo el marcado <span class="...">, los nodos de vocabulario y el análisis filológico deben realizarse SOBRE LA TRADUCCIÓN EN ESPAÑOL.
3. Si el texto ya está en español, procésalo directamente.
...
0. Idioma del texto: El contenido textual dentro del array "stanzas" DEBE ESTAR SIEMPRE EN ESPAÑOL (si el texto original estaba en otro idioma, coloca aquí tu traducción literaria anotada).
